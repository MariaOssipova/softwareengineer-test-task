...
/**
 * Generated from protobuf message <code>Category</code>
 */
class Category extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .Score score_for_date = 3;</code>
     */
    private $score_for_date;
    /**
     * Generated from protobuf field <code>.Score overall_score = 4;</code>
     */
     ...
     *     @type float $ratings
     *     @type \Score[]|\Google\Protobuf\Internal\RepeatedField $score_for_date
     *     @type \Score $overall_score
     * }
     */
    ...
    {
        GPBUtil::checkMessage($var, \Score::class);
